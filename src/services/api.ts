...
function normalizeProject(project: any): Project {
  ...
  return {
    ...
    productTitle: project.productTitle || meta.productTitle,
    productPrice: project.productPrice ?? meta.productPrice,
    productImageUrl: project.productImageUrl || meta.productImageUrl,
    productBuyUrl: project.productBuyUrl || meta.productBuyUrl || meta.productUrl,
  ...
  productGroups: [
    {
      ...
      products: [
        ...
        },
        {
          ...
          price: 42.49,
          currency: 'USD',
          description: 'Corner Floor Lamp - Smart RGB LED Corner Lamp with App and Remote Control, 16 Million Colors & 68+ Scene, Music Sync, Timer Setting - Ideal for Living Rooms, Bedrooms, and Gaming Rooms 1_Pack.',
          bullets: [
            'Create Your Perfect Atmosphere - With 16 million color options and 68 dynamic lighting modes, this RGB floor lamp lets you customize your lighting to match any mood or occasion.',
            'Convenient Control Options - Control your corner floor lamp with ease using the included remote control or the Bluetooth app. Adjust color, brightness, effects, and timer schedules.',
            'Sync with Your Music - Built-in sensitive microphone syncs lighting to the rhythm of your music, movies, or games with Music Voice Control mode.',
            'Simple Installation, Versatile Use - Tool-free setup in minutes. Minimalist corner-fit aluminum frame (55.9" Height).',
            'Reliable Customer Service - Lifetime warranty service from Miortior. Includes lamp, remote, 12V adapter, and manual.',
          ],
          specs: [
            { name: 'Product Dimensions', value: '5.04"D x 4.53"W x 55.9"H' },
            { name: 'Light Source Type', value: 'LED (16M RGB Colors & 68+ Scenes)' },
            { name: 'Control Method', value: 'Bluetooth App & RF Remote Control' },
            { name: 'Power / Voltage', value: '12W / 12V (110V AC Adapter)' },
          ...
          imageUrls: [
            ...
            '/api/images/proxy?url=' + encodeURIComponent('https://m.media-amazon.com/images/I/614i4JgyiiL._AC_SL1500_.jpg'),
            ...
            '/api/images/proxy?url=' + encodeURIComponent('https://m.media-amazon.com/images/I/71nCfPSdHEL._AC_SL1500_.jpg'),
          ],
          externalUrl: 'https://www.amazon.com/dp/B0BXWQHYVQ',
          checkoutType: 'AMAZON',
          buttonTextOverride: 'Buy on Amazon ($42.49)',
        },
      ],
    },
  ],
